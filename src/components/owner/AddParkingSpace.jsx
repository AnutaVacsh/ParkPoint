...
const AddParkingSpace = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const parkingSpaceDto = {
      ...
      hourlyPrice: hourlyPrice ? parseInt(hourlyPrice)*100 : null,
      dailyPrice: dailyPrice ? parseInt(dailyPrice)*100  : null,
      weeklyPrice: weeklyPrice ? parseInt(weeklyPrice)*100  : null,
      monthlyPrice: monthlyPrice ? parseInt(monthlyPrice)*100  : null,
      isAvailable: "PENDING",
